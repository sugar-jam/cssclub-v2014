			...
			<div class="bm bml" style="padding: 10px 20px 5px 20px; margin-bottom: 20px;">
				...
				<div class="bm_h cl" style="border-bottom: 0;">
                    ...
                    <span style="float: left;"><h1 class="xs2">
						<a href="forum.php?mod=forumdisplay&fid=$_G[fid]" style="font-size: 16px; font-family: 'Microsoft Yahei'; color: #35B5EB;">$_G['forum'][name]</a>
                    ...
                    <div class="pgs" style="float: right; margin: 5px 0 0 0; _margin: 0;">
		...
		<div class="sd">
			...
			<!--{if !$subforumonly}-->
				<div class="bm">
					...
					<div class="bm_c" style="padding: 15px 10px 10px 10px;">
						<ul class="xl xl2 cl">
						<!--{loop $_G['cache']['forums'] $bforum}-->
							<!--{if $bforum['fup'] == $_G['forum']['fup'] && $bforum['status']}-->
								<li style="margin: 0 0 6px 0; height: 22px; line-height: 22px;"><a href="forum.php?mod=forumdisplay&fid=$bforum[fid]" style="display: block; width: 83px; height: 22px; line-height: 22px; text-align: center; padding: 0; color: #FFFFFF; overflow: hidden; background: #35B5EB;">$bforum['name']</a></li>
							<!--{/if}-->
						<!--{/loop}-->
						</ul>
					</div>
