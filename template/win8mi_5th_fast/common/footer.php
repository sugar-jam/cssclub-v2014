  ...
  <div id="ft" class="wp cl">
    ...
    <div class="widget-2 last widget">
     <div class="borders">
      ...
      <p>Powered by <a href="http://www.discuz.net" target="_blank" style="color: #888888;">Discuz!</a> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}-->
        &copy; 2001-2013 <a href="http://www.comsenz.com" target="_blank" style="color: #888888;">Comsenz Inc.</a><!--{if $_G['setting']['icp']}--> <a href="http://www.miitbeian.gov.cn/" target="_blank" style="color: #888888;">$_G['setting']['icp']</a><!--{/if}--> </p>
